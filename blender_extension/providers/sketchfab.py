...
SKETCHFAB_API_TIMEOUT_SECONDS = 30
SKETCHFAB_DOWNLOAD_TIMEOUT_SECONDS = 60

class SketchfabProviderMixin:
        ...
        if api_key:
            try:
                ...
                response = requests.get(
                    ...
                    headers=headers,
                    timeout=SKETCHFAB_API_TIMEOUT_SECONDS
                )
    ...
    def get_sketchfab_model_preview(self, uid):
        ...
        try:
            ...
            img_response = requests.get(
                thumbnail_url, timeout=SKETCHFAB_API_TIMEOUT_SECONDS
            )
    ...
    def download_sketchfab_model(self, uid, normalize_size=False, target_size=1.0):
        ...
        try:
            ...
            model_response = requests.get(
                download_url, timeout=SKETCHFAB_DOWNLOAD_TIMEOUT_SECONDS
            )
