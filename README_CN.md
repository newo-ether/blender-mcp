...
| `get_geometry_node_type_schema` | 从当前运行的 Blender 中读取节点插槽和可编辑属性。 | 否 |
...
- 自动安装仅支持 Windows。
- Blender 5.1.2 和 5.2 LTS RC 已通过本地验收测试。扩展清单声明的最低版本是 Blender 4.2，但目前还没有在该版本上做实际运行测试。
